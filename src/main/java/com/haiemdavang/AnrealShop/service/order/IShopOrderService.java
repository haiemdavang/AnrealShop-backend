...
public interface IShopOrderService {
    ...
    List<ShopOrder> getShopOrdersByOrderId(String orderId);
    List<ShopOrder> getShopOrdersByOrderIds(Set<String> shopOrderIds);
    ShopOrder getShopOrderById(String shopOrderId);
}